...
sys.path.insert(0, THIS_DIR)  # so datamodule/espnet/cosine import as top-level
...
CKPT = os.path.join(os.path.dirname(THIS_DIR), "models", "aditeya-vsr", "pytorch_model.pt")
