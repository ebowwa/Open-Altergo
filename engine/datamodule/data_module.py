...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        dataset = AVDataset(
            ...
            audio_transform=(
                AudioTransform("train") if self.args.modality == "audio" else None
            ),
            video_transform=(
                VideoTransform("train") if self.args.modality == "video" else None
            ),
        )
    ...
    def val_dataloader(self):
        dataset = AVDataset(
            ...
            modality=self.args.modality,
            audio_transform=(
                AudioTransform("val") if self.args.modality == "audio" else None
            ),
            video_transform=(
                VideoTransform("val") if self.args.modality == "video" else None
            ),
        )
        dataset = CustomBucketDataset(
    ...
    def test_dataloader(self):
        dataset = AVDataset(
            ...
            ) if self.args.modality == "audio" else None,
            video_transform=(
                VideoTransform("test") if self.args.modality == "video" else None
            ),
        )
