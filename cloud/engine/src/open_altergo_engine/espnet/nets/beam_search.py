...
from open_altergo_engine.espnet.nets.e2e_asr_common import end_detect
from open_altergo_engine.espnet.nets.scorer_interface import PartialScorerInterface, ScorerInterface
