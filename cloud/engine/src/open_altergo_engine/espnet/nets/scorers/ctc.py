...
from open_altergo_engine.espnet.nets.ctc_prefix_score import CTCPrefixScore, CTCPrefixScoreTH
from open_altergo_engine.espnet.nets.scorer_interface import BatchPartialScorerInterface
