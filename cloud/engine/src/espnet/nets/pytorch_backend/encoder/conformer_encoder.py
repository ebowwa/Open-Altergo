...
from open_altergo_engine.espnet.nets.pytorch_backend.transformer.attention import RelPositionMultiHeadedAttention
from open_altergo_engine.espnet.nets.pytorch_backend.transformer.embedding import RelPositionalEncoding
