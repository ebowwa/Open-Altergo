import torch
import torchaudio
from open_altergo_engine.cosine import WarmupCosineScheduler
from open_altergo_engine.datamodule.transforms import TextTransform

from open_altergo_engine.espnet.nets.batch_beam_search import BatchBeamSearch
from open_altergo_engine.espnet.nets.pytorch_backend.e2e_asr_conformer import E2E
from open_altergo_engine.espnet.nets.scorers.length_bonus import LengthBonus
...
class ModelModule(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # all_gather returns a scalar on a single device and a vector under
        # distributed training. numel() handles both cases.
        loss *= batch_sizes.numel() / batch_sizes.sum()  # world size / batch size
